...
// 🎨 REDESIGNED - With Graphs & Visualizations - FIXED
...
export default function InsightsScreen() {
  ...
  const chartData = useMemo(() => {
    ...
    // FIX: Ensure at least some data for better visualization
      ...
      >
        ...
        <View style={styles.viewToggle}>
          <TouchableOpacity
            ...
            style={[
              ...
              selectedView === 'insights' && { backgroundColor: theme.tint }
            ]}
          >
            <Ionicons 
              name="bulb" 
              size={16} 
              color={selectedView === 'insights' ? 'white' : theme.text} 
            />
            <Text style={[
          ...
          <TouchableOpacity
            ...
            style={[
              styles.viewToggleButton,
              selectedView === 'trends' && { backgroundColor: theme.tint }
            ]}
          >
            <Ionicons 
              name="trending-up" 
              size={16} 
              color={selectedView === 'trends' ? 'white' : theme.text} 
            />
            <Text style={[
              styles.viewToggleText,
              { color: selectedView === 'trends' ? 'white' : theme.text }
        ...
        {selectedView === 'trends' ? (
          ...
          <View style={styles.chartsContainer}>
            ...
            {/* Monthly Comparison - FIX: Proper BarChart usage */}
            <View style={[styles.chartCard, { backgroundColor: theme.card }]}>
              <View style={styles.chartHeader}>
            ...
            <View style={styles.filterContainer}>
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterChip,
                    selectedCategory === 'critical' && { backgroundColor: '#EF4444' }
                  ]}
                >
                  <Text style={[
                    styles.filterChipText,
                    { color: selectedCategory === 'critical' ? 'white' : theme.text }
                  ]}>
                    Priority
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterChip,
                    selectedCategory === 'tips' && { backgroundColor: '#10B981' }
                  ]}
                >
                  <Text style={[
                    styles.filterChipText,
                    { color: selectedCategory === 'tips' ? 'white' : theme.text }
                  ]}>
                    Tips
                  </Text>
                </TouchableOpacity>
              ...
              >
                ...
                <Text style={[styles.emptySubtitle, { color: theme.subtext }]}>
                  {selectedCategory === 'all' 
                    ? "No insights right now. Keep tracking!"
        ...
        <View style={styles.aiBadgeContainer}>
          <View style={[styles.aiBadge, { backgroundColor: theme.card }]}>
            ...
            <Text style={[styles.aiBadgeText, { color: theme.subtext }]}>
              Powered by TF-IDF ML Model
            </Text>
          </View>
        </View>
...
function InsightCard({ insight, theme, getPriorityData, index }: InsightCardProps) {
    ...
    >
      <View style={[
        ...
        <View style={styles.rightSection}>
          ...
          <Text style={[styles.insightDescription, { color: theme.subtext }]}>
            {insight.description}
          </Text>
          ...
          {insight.actionable && insight.action && (
            <TouchableOpacity
              ...
              onPress={() => console.log('Action:', insight.action?.handler)}
              activeOpacity={0.8}
            >
              <Text style={[styles.actionButtonText, { color: priorityData.color }]}>
